...
dependencies {
    ...
    implementation("org.bitbucket.qhuyy.hyticallib-i18n:hyticallib-i18n-core:main-SNAPSHOT)
    implementation("org.bitbucket.qhuyy.hyticallib-i18n:hyticallib-i18n-bukkit:main-SNAPSHOT)
}
